            ...
            using (var p = new ExcelPackage())
            {
                ...
                else
                {
                    ...
                    foreach (var barcode in barcodes)
                    {
                        ...
                        if (inItem == null) { inItem = new StockOrderItemsModel {
                             actual_qty = 0, Barcode = barcode , free_qty = 0 ,  Itemean = OutItem.Itemean,
                             ItemName = OutItem.ItemName, Unit = OutItem.Unit, UnitName = OutItem.UnitName
                        }; }
